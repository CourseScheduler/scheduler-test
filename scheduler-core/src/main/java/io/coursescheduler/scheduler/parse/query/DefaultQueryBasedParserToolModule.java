/**
 * @(#)DefaultQueryBasedParserToolModule.java
 *
 ...
 *
 */
public class DefaultQueryBasedParserToolModule extends AbstractModule {
	...
	protected void configure() {
		...
		MapBinder<String, QueryBasedParserTool> toolBinder = MapBinder.newMapBinder(binder(), String.class, QueryBasedParserTool.class);
	}
